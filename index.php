                ...
                <form method="POST" action="confirmation.php">
                    ...
                    <div class="form-row ">
                        <div class="form-group col-lg-4">
                            ...
                            <input type="text" class="form-control" id="inputPatientName" name="patient_name" placeholder="" required>
                        </div>
                        <div class="form-group col-lg-4">
        ...
        <div class="row">
            <div class="col-md-7">
                <div class="form_container">
                    <!-- Form Action points to 'form-submitted.php' -->
                    <form method="POST" action="form-submitted.php">
                        <div>
