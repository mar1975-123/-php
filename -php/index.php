...
<body>
 ...
 <div id="scrollingText">
    <span id="text1" class="scrolling">ეს არის პირველი ტექსტი!</span>
    <span id="text2" class="hidden scrolling">ეს არის მეორე ტექსტი!</span>
    <span id="text3" class="hidden scrolling">ეს არის მესამე ტექსტი!</span>
 </div>
 ...
 <script>
    ...
    function switchText() {
        ...
        texts[currentText].classList.add('scrolling');
    }

    function startAnimation() {
        const currentElement = texts[currentText];
        currentElement.classList.remove('scrolling');
